...
open class ReadLocator : Locator, Parcelable {
    ...
    constructor() : this("", "", 0, Locations(), 0)

    constructor(bookId: String, href: String, created: Long, locations: Locations, page: Int) :
            this(bookId, href, created, "", locations, null, page)
